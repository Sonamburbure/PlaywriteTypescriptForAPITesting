...
export class EventPreplanningManualOverridesApi{
...
async createEventPreplanningManualOverride(payload:any){
    ...
    const response = await this.apiContext.post(
        `${BASE_API_URL}/${tenantPath}/api/${logonAs}/eventmanualoverride`,
        {
          headers: {
