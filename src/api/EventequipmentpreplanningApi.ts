...
export class EventEquipmentPreplanningApi{
...
async createEventEquipmentPreplanning(payload:any){
    ...
    const response = await this.apiContext.post(
        `${BASE_API_URL}/${tenantPath}/api/${logonAs}/eventequipmentpreplanning`,
        {
          headers: {
